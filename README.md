...
- [1-4.LD_PRELOAD技術](1-4.md) [20240128直播教學錄影](https://youtu.be/UgnfeIzjEio)
## 第二單元:Linux 執行檔分析(Linux Binary Analysis)
- [2-1.基本Linux 執行檔分析:file|size|string|hexdump|hd](2-1.md)[直播教學錄影]()
- [2-2.Linux 執行檔結構ELF(Executable and Linkable Format)](2-2.md)[直播教學錄影]()
