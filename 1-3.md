...
```
- 編譯 ==> gcc -o ex3a ex3a.c
- 顯示不同區端的大小:size ex3a
```
   text	   data	    bss	    dec	    hex	filename
   1415	    544	      8	   1967	    7af	ex3a
```
## example 3b:
```c
...
```
- 編譯 ==> gcc -o ex3b ex3b.c
- 顯示不同區端的大小:size ex3b
```
   text	   data	    bss	    dec	    hex	filename
   1415	    544	      8	   1967	    7af	ex3b
```
## example 3c
```c
#include <stdio.h>
...
```
- 編譯 ==> gcc -o ex3c ex3c.c
- 顯示不同區端的大小:size ex3c
```
   text	   data	    bss	    dec	    hex	filename
   1415	    544	     16	   1975	    7b7	ex3c
```
## example 3d
```c
#include <stdio.h>
...
```
- 編譯 ==> gcc -o ex3d ex3d.c
- 顯示不同區端的大小:size ex3d
```
   text	   data	    bss	    dec	    hex	filename
   1415	    548	     12	   1975	    7b7	ex3d
```
## example 3e
```c
#include <stdio.h>
...
```
- 編譯 ==> gcc -o ex3e ex3e.c
- 顯示不同區端的大小:size ex3e
```
   text	   data	    bss	    dec	    hex	filename
   1415	    552	      8	   1975	    7b7	ex3e
```
## example 4:
```c
